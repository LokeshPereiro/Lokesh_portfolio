...
export const LandingPage = () => {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I'm Lokesh Pereiro.</span> I'm a{" "}
        <span className="font-bold">full-stack developer.</span>{" "}
        <span className="italic">
          Oriented and passionate about MERN Stack technologies.
        </span>{" "}
        Currently I focus on
        <span className="font-bold"> Next.js & TypeScript</span>.
      </motion.h1>
